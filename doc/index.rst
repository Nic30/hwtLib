...
hwtLib is package of hardware components (like vhld/verilog library) for HWToolkit (hwt python3 package) it
also contains commonly used helpers and types like uint64_t, UDP header etc.
