...
This is something which will greatly confuse you if you are comming from VHDL/Verilog word where using of generate statements have serious limits, but it has serious advantages.
