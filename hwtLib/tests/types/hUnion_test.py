...
class HUnionTC(unittest.TestCase):
...
if __name__ == '__main__':
    ...
    # suite = unittest.TestSuite([HUnionTC("testValue")])
    suite = testLoader.loadTestsFromTestCase(HUnionTC)
