...
class HwIOSynthesizerTC(BaseSynthesizerTC):
    ...
    def test_signalInstances(self):
        ...
        port_a = list(where(bram._rtlCtx.hwModDec.ports, lambda x: x.name == "a"))
        port_b = list(where(bram._rtlCtx.hwModDec.ports, lambda x: x.name == "b"))
        ...
        self.assertEqual(len(bram._rtlCtx.hwModDec.ports), 2,
