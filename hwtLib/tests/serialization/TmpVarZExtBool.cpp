...
SC_MODULE(TmpVarZExtBool) {
    ...
    void assig_process_o0_2b() {
        o0_2b.write(static_cast<sc_uint<2>>(a.read() < b.read()));
    }

    void assig_process_o0_2b_s() {
        o0_2b_s.write(static_cast<sc_int<2>>(static_cast<sc_uint<2>>(a.read() < b.read())));
    }

    void assig_process_o0_2b_u() {
        o0_2b_u.write(static_cast<sc_uint<2>>(static_cast<sc_uint<2>>(a.read() < b.read())));
    }

    void assig_process_o0_3b() {
        o0_3b.write(static_cast<sc_uint<3>>(a.read() < b.read()));
    }

    void assig_process_o0_3b_s() {
        o0_3b_s.write(static_cast<sc_int<3>>(static_cast<sc_uint<3>>(a.read() < b.read())));
    }

    void assig_process_o0_3b_u() {
        o0_3b_u.write(static_cast<sc_uint<3>>(static_cast<sc_uint<3>>(a.read() < b.read())));
    }

    SC_CTOR(TmpVarZExtBool) {
