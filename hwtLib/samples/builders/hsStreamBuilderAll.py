...
class HsStreamBuilderSplit(Unit):
    ...
    def _declr(self):
        ...
        self.b_1 = Handshaked()
        self.b_2 = Handshaked()
        self.b_selected = Handshaked()
        self.b_selected.DATA_WIDTH.set(2)
        ...
        self.e_selected.DATA_WIDTH.set(2)
    ...
    def _impl(self):
        ...
        b = HsBuilder(self, self.b)\
                .split_fair_to(self.b_0, self.b_1, self.b_2, exportSelected=True)
        
        self.b_selected ** b.lastComp.selected
        ...
        HsBuilder(self, self.d)\
            .split_select_to([1,2,3],
                             self.d_0, self.d_1, self.d_2, self.d_3, self.d_3)

        # explicitly select output
        HsBuilder(self, self.e)\
            .split_select_to(self.e_select,
                             self.e_0, self.e_1, self.e_2, self.e_3, self.e_3)
