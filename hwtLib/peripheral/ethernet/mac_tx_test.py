...
class EthernetMacTx_8b_TC(SimTestCase):
    ...
    def pop_tx_frame(self):
        return axi4s_receive_bytes(self.dut.phy_tx)
...
if __name__ == "__main__":
    ...
    # suite = unittest.TestSuite([EthernetMacTx_32b_TC("test_single")])
    loadedTcs = [testLoader.loadTestsFromTestCase(tc) for tc in EthernetMac_tx_TCs]
